...
class MainSenBirdPage extends StatefulWidget {
  const MainSenBirdPage({Key? key}) : super(key: key);

  @override
  State<MainSenBirdPage> createState() => _MainSendBirdPageState();
}

class _MainSendBirdPageState extends State<MainSenBirdPage> {
  @override
